...
export const refereeFormDefinition: DefinitionAccordion[] = [
  {
  ...
  },
  {
    ...
    panelTitle: 'Datos del arbitro',
    panelDescription: 'Completa los datos del arbitro',
    panelIcon: 'check_circle',
    step: 1,
    hidden: false,
    disabled: false
  },
  {
    ...
    panelTitle: 'Foto',
    panelDescription: 'Cargar foto del arbitro',
    panelIcon: 'check_circle',
    step: 2,
    hidden: false,
    disabled: false
